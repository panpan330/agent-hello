...
当前阶段：阶段 6 生产化与评测已完成，第 36 节 阶段 6 项目整理和面试表达 已完成。下一步按 M6 快速版进入作品整理和面试准备，共 5 节，完成后进入新技术主线。
...
| M6 | 第 12 周 | 作品整理 | 未开始 | 快速版 5 节：项目定位、README、架构图/流程图、运行说明/演示脚本、简历/面试问答 |
...
| 节 | 主题 | 状态 | 目标 |
| --- | --- | --- | --- |
| 1 | 项目定位和作品化目标 | 未开始 | 讲清楚这个项目是什么、为什么不是完整生产系统但仍然可以作为 AI 工程作品 |
| 2 | 整理 GitHub 首页 README | 未开始 | 整理项目介绍、技术栈、目录结构、学习阶段、核心能力和运行入口 |
| 3 | 架构图和核心流程图 | 未开始 | 整理整体架构、RAG 流程、Agent 工单流程、工具调用安全流程 |
| 4 | 本地运行说明和演示脚本 | 未开始 | 写清楚如何启动服务、如何演示知识库问答、查订单、创建工单、评测和 CI |
| 5 | 简历描述、面试讲稿、常见追问 | 未开始 | 准备 1/3/5 分钟讲法、简历 bullet、常见面试问答、项目不足和后续路线 |
